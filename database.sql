...
-- 3 The bank is giving a new customer bonus! How do you update all records with an account balance of 0.00 and 
...
-- 5 How do you get the username and account balance of the 3 users with the highest balances, sorted highest 
-- to lowest balance? NOTE: Research LIMIT
...
VALUES('Brian', 'Bloomington', 1, 1, 9999999999.99);
